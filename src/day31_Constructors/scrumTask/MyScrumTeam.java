...
public class MyScrumTeam {
    ...
    public static void main(String[] args) {
        ...
        Tester tester1= new Tester("Layan", 11, "SDET", 110000);
   Tester tester2= new Tester( "Ali", 43,"QA", 142000);
...
Developer[] developers = {developer2, developer3, developer4};
   // 1 ScrumTeam Object
ScrumTeam scrum= new MyScrumTeam( "Nigara", "Huseyin", "Neira", 14);
...
scrum.addDeveloper(developer1);
    ...
    for(Developer eachDeveloper: scru.devopsList){
    Systm.out.println(eachDeveloper.name + " : " + eachDeveloper.salary);
    }
